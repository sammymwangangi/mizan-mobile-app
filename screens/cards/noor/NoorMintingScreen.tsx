...
import { NOOR_ANALYTICS } from '../../../constants/noor';
import {
  TnCSheet,
  MintingSheet,
  CancelSheet,
  ErrorSheet,
  SuccessSheet
} from '../../../components/cards/noor/NoorBottomSheets';
import * as Haptics from 'expo-haptics';

type NoorMintingNavigationProp = NativeStackNavigationProp<RootStackParamList, 'NoorMinting'>;
type NoorMintingRouteProp = RouteProp<RootStackParamList, 'NoorMinting'>;

const NoorMintingScreen: React.FC = () => {
  const navigation = useNavigation<NoorMintingNavigationProp>();
  const route = useRoute<NoorMintingRouteProp>();
...
export default NoorMintingScreen;
