...
import { View, Text, TouchableOpacity, ScrollView, Alert, Animated, Switch } from 'react-native';
...
import { BARAKAH_BLUE, BARAKAH_PURPLE, NOOR_COLORS, NOOR_FEATURES } from '../../../constants/noor';
import { FONTS } from 'constants/theme';
import { MintingSheet, CancelSheet, ErrorSheet, SuccessSheet, TnCSheet } from '../../../components/cards/noor/NoorBottomSheets';
import { QAMAR_COLORS } from 'constants/qamar';


type NoorReviewNavigationProp = NativeStackNavigationProp<RootStackParamList, 'NoorReview'>;
type NoorReviewRouteProp = RouteProp<RootStackParamList, 'NoorReview'>;
...
const toggleOptions: ToggleOption[] = [
    {
        id: 'smartSpend',
        title: 'SmartSpend™',
        description: 'Intelligent spending insights and categorization',
    },
    {
        id: 'fraudShield',
        title: 'FraudShield™',
...
const NoorReviewScreen: React.FC = () => {
    const navigation = useNavigation<NoorReviewNavigationProp>();
    const route = useRoute<NoorReviewRouteProp>();
    ...
    const handleTermsToggle = () => {
        ...
        setShowTnc(true);
        // PostHog.capture?.(NOOR_ANALYTICS.CARD_TNC_OPEN);
        Haptics.selectionAsync();
    };
    ...
    const handleSuccessComplete = () => {
        ...
        // PostHog.capture?.(NOOR_ANALYTICS.CARD_ORDER_SUCCESS);
        const cardId = `noor-${Date.now()}`;
        navigation.navigate('NoorOrderStatus', { planId, selectedColor, cardId });
    };

    // Auto-progress minting similar to NoorMintingScreen
    useEffect(() => {
    ...
    const handleOrderCard = () => {
        ...
        // Track analytics
        // PostHog.capture?.(NOOR_ANALYTICS.CARD_ORDER_SUBMIT, {
        //   plan: 'noor',
        //   toggles: features
        // });
    ...
    const FeatureToggle: React.FC<{
        feature: typeof NOOR_FEATURES[0],
        value: boolean,
        onToggle: () => void
        ...
        <View className="flex-1 bg-white">
            ...
            <ScrollView className="flex-1 px-5" showsVerticalScrollIndicator={false}>
                ...
                <View className="mb-6">
                    <View className="bg-white">
                        {NOOR_FEATURES.map((feature, index) => (
                            <View key={feature.id}>
                                <FeatureToggle
                                    feature={feature}
            ...
            <View className="px-5 pb-8">
                ...
                >
                    ...
                    >
                        <Text className="text-white font-semibold text-lg">Mint my Card</Text>
                    </LinearGradient>
                    {!termsAccepted && (
...
export default NoorReviewScreen;
