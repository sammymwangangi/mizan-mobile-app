...
type QamarMintingNavigationProp = NativeStackNavigationProp<RootStackParamList, 'QamarMinting'>;
type QamarMintingRouteProp = RouteProp<RootStackParamList, 'QamarMinting'>;

const QamarMintingScreen: React.FC = () => {
  const navigation = useNavigation<QamarMintingNavigationProp>();
  const route = useRoute<QamarMintingRouteProp>();
...
export default QamarMintingScreen;
