...
type SendMoneyConfirmationRouteProp = RouteProp<RootStackParamList, 'SendMoneyConfirmation'>;
type SendMoneyConfirmationNavigationProp = NativeStackNavigationProp<RootStackParamList, 'SendMoneyConfirmation'>;

const SendMoneyConfirmationScreen = () => {
  const insets = useSafeAreaInsets();
  const navigation = useNavigation<SendMoneyConfirmationNavigationProp>();
  const route = useRoute<SendMoneyConfirmationRouteProp>();
