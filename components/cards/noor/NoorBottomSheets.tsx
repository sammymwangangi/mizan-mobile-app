      ...
      >
        <BottomSheetView style={{ flex: 1 }}>
          ...
          <View className="px-6 pb-8">
            ...
            <TouchableOpacity onPress={onDecline} className="w-full h-14 bg-[#E0D2FF] rounded-full justify-center items-center mt-3" style={{ borderRadius: 40 }}>
              <Text style={{ ...FONTS.semibold(16), color: '#FFFFFF' }}>Decline & Exit</Text>
            </TouchableOpacity>

            <TouchableOpacity onPress={handleEmailCopy} className="mt-3" style={{ alignSelf: 'center' }}>
...
export const SuccessSheet: React.FC<SuccessSheetProps> = ({ visible, onComplete }) => (
  <Modal visible={visible} transparent animationType="fade">
    <View className="flex-1 bg-black/50 items-center justify-center">
      <ConfettiBurst visible={visible} onComplete={onComplete} colors={[BARAKAH_PURPLE, '#9F7AFF']} />
      ...
      >
        ...
        <AnimatedSuccessCheck visible={visible} size={120} color={BARAKAH_PURPLE} />
      ...
      <View className="flex-1 bg-black/50 justify-end">
        <View style={{ position: 'relative', alignItems: 'center', marginBottom: 24 }}>
          ...
          <View style={{ width: 340, height: 300, backgroundColor: '#FFFFFF', borderTopLeftRadius: 24, borderTopRightRadius: 24, borderBottomLeftRadius: 24, borderBottomRightRadius: 24, alignItems: 'center', paddingTop: 14 }}>
            ...
            <View style={{ width: 118, height: 118, borderRadius: 59, borderWidth: 3, borderColor: BARAKAH_PURPLE, alignItems: 'center', justifyContent: 'center' }}>
              <Check size={44} color={BARAKAH_PURPLE} strokeWidth={3} />
            </View>
      ...
      <View className="flex-1 bg-black/50 justify-end">
        <View style={{ position: 'relative', alignItems: 'center', marginBottom: 24 }}>
          ...
          <View style={{ width: 340, height: 300, backgroundColor: '#FFFFFF', borderRadius: 24, alignItems: 'center', paddingTop: 14 }}>
            ...
            <AnimatedSuccessCheck visible={visible} size={76} color={BARAKAH_PURPLE} />
