...
import type { QamarColor } from '../../../constants/qamar';
    ...
    <View style={[styles.wrapper, { width, height }]}> 
      <View style={[styles.card, { width, height, borderRadius: RADIUS }]}> 
        <Svg width={width} height={height}>
          ...
          {/* Subtle background shapes at low opacity */}
          <G opacity={0.2}>
            {toComponent(Rectangle1) ? React.createElement(toComponent(Rectangle1)!, { width, height }) : null}
...
export default QamarCardPreview;
